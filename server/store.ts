...
const fixture = (id: string, title: string, characterName: string): Book => ({
  id,
  title,
  ...
  private async ensureSeeded() {
    this.seedPromise ??= (async () => {
      try {
        ...
        await this.saveBook(fixture('the-observatory', 'The Observatory', 'Mira'));
        await this.saveBook(fixture('harbor-at-noon', 'Harbor at Noon', 'Rowan'));
      }
    })();
