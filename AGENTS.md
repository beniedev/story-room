...
- The local host defaults to loopback but may bind to an explicitly configured LAN or private-network address. Do not add password/token gates, Host allowlists, or other controls that block direct LAN or Tailscale use.
